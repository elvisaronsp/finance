...
namespace Finance.Controllers
{
    ...
    public class CounterpartiesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,OwneshipTypeId,Name,FullName,VATPayer,CodVATPayer,VATCertificateNumber,BankName,AccountNumber,BankMFO,EDRPO,LegalAdress,ActualAddress,PhoneNumber,ContactPerson,Comment,Discount")] Counterparty counterparty)
        {
            if (ModelState.IsValid)
            {
